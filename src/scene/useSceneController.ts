...
export function useSceneController() {
  ...
  return {
    ...
    selectedContextNoteIds: ambient.selectedContextNoteIds,
    ...
    onFocusSelectedNote: ambient.onFocusSelectedNote,
    onFocusSelectedCluster: ambient.onFocusSelectedCluster,
    onResetView: ambient.onResetView,

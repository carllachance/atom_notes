...
export const RELATIONSHIP_VISUAL_TOKENS = {
  ...
  semantic: {
    direct: {
      ...
      node: { borderStyle: 'solid', backgroundOpacity: 0.64, labelOpacity: 0.76, glowOpacity: 0.18 }
    },
    inferred: {
      edge: { strokeWidth: 1.45, dasharray: '7 9', baseOpacity: 0.14, scoreOpacityRange: 0.13, maxOpacity: 0.36, blurRadius: 4 },
      node: { borderStyle: 'dashed', backgroundOpacity: 0.48, labelOpacity: 0.62, glowOpacity: 0.1 }
    }
  },
  project: {
    connector: { strokeWidth: 18, opacity: 0.22, blurRadius: 8, dasharray: 'none' },
    note: { memberOpacityMultiplier: 1, memberGlowStrength: 0.22, subordinateOpacityMultiplier: 0.74, subordinateScale: 0.985 }
  },
  emphasis: {
    default: { edgeOpacityMultiplier: 1, nodeOpacityMultiplier: 1, glowOpacityMultiplier: 1 },
    hovered: { edgeOpacityMultiplier: 1.12, nodeOpacityMultiplier: 1.08, glowOpacityMultiplier: 1.12 },
    selected: { edgeOpacityMultiplier: 1.22, nodeOpacityMultiplier: 1.14, glowOpacityMultiplier: 1.18 }
  }
} as const;
...
export function getProjectNoteVisual(state: ProjectNoteVisualState) {
  ...
  return { opacityMultiplier: 1, scaleMultiplier: 1, glowStrength: 0 };
}
